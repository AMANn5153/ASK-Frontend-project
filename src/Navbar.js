...
import {ask} from './Welcome/Darray'
           ...
           <Link to='/'> {
            ...
            <div className='nav-div-list-styl'>
                <ul className='ul-styl'>
                    ...
                    <li><div className='div-link'><NavLink exact className="active_class " to="/Write">Write</NavLink></div></li>
                    <li><div className='div-link'><NavLink exact  className="active_class " to="/Read">Read</NavLink></div></li>
                    <li><div className='div-link'><NavLink exact className="active_class "  to="/Dash">Ask</NavLink></div></li>
                </ul>
            </div>
